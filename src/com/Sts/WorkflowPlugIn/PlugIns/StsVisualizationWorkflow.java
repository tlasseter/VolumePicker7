...
public class StsVisualizationWorkflow extends StsWorkflowPlugIn
{
    public StsVisualizationWorkflow()
    {
        name = "StsVisualizationWorkflow";
        workflowName = "Visualization";
        checkName();
        description = new String("Loads and displays 3D seismic attribute volumes, well, logs, and surfaces");
    ...
    public void createWorkflowNodes(StsTreeModel treeModel, StsWorkflowTreeNode workflowRoot)
    {
        ...
        createGroupAndNodes(workflowRoot, treeModel, LOAD_DATA, new byte[] {L_PRESTACK2D, L_PRESTACK3D, L_POSTSTACK2D, L_POSTSTACK3D, L_WELLSANDLOGS, L_SENSOR, L_SURFACE, L_COLORPALETTE, L_CULTURE, L_ANCILLARY});        
