package com.Sts.Utilities.DateTime;
...
public class CalendarParser
{
            ...
            throws CalendarParserException
    {
        ...
        // Calendar Parser has problems with more than 3 digits after the decimal
        if(dateStr.contains("."))
        {
            if(dateStr.length() > dateStr.indexOf(".") + 4)
                 dateStr = dateStr.substring(0, dateStr.indexOf(".") + 4);
        }
