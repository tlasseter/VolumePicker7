...
public class StsBuildSections extends StsAction implements Runnable
{
    ...
    static final int AUXILIARY = StsParameters.AUXILIARY;
 	...
 	public StsBuildSections(StsActionManager actionManager)
    {
        super(actionManager);
	...
	public void run()
    {
        ...
        {
            StsException.outputException("StsBuildSections.run() failed.", e, StsException.WARNING);
        }
    }
...
//                    lastLine.insertSurfaceVertex(vertex);
        ...
        {
            StsException.outputException("StsBuildSections.constructSectionsFromEdges() failed.",
    ...
    private void intersectSections()
    {
        ...
        {
            StsException.outputException("StsBuildSections.intersectSections() failed.",
                e, StsException.WARNING);
            return;
        }
    }
