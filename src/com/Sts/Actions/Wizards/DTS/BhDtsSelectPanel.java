...
public class BhDtsSelectPanel extends StsJPanel implements StsFileTransferObjectFaceNew
{
	private StsFileTransferPanel selectionPanel;

	private BhDtsLoadWizard wizard;
	private BhDtsSelect wizardStep;
	private StsModel model;
	private String outputDirectory = null;
    private boolean archiveIt = true;

	public BhDtsSelectPanel(BhDtsLoadWizard wizard, StsWizardStep wizardStep)
	{
		this.wizard = wizard;
		this.wizardStep = (BhDtsSelect) wizardStep;
