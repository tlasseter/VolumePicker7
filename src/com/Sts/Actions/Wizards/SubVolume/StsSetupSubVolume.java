...
public class StsSetupSubVolume extends StsWizardStep implements Runnable
{
    public StsStatusPanel panel;
    private StsHeaderPanel header;
    private StsToolbar subVolumeToolbar = null;

    public StsSetupSubVolume(StsWizard wizard)
    {
