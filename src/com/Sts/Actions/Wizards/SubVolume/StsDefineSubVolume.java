...
public class StsDefineSubVolume extends StsWizardStep
{
    StsDefineSubVolumePanel panel;
    StsHeaderPanel header;

    public StsDefineSubVolume(StsWizard wizard)
    {
        super(wizard);
        panel = new StsDefineSubVolumePanel(wizard, this);
        header = new StsHeaderPanel();
        setPanels(panel, header);
        panel.setPreferredSize(new Dimension(500, 500));
        header.setTitle("Sub-Volume Definition");
        header.setSubtitle("Defining Sub-Volume Type");
