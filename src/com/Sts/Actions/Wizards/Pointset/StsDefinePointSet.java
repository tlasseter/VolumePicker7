...
public class StsDefinePointSet extends StsWizardStep
{
    StsDefinePointSetPanel panel;
    StsHeaderPanel header;

    public StsDefinePointSet(StsWizard wizard)
    {
        super(wizard);
        panel = new StsDefinePointSetPanel(wizard, this);
        ...
        header.setInfoText(wizardDialog,"(1) Select the desired volumes from the left list and move them to the right list.\n" +
                                   ...
                                   "   ***** A point set is a prefix of samples extracted from each volume with \n" +
    ...
    public float getSetPercentage() { return panel.getSetPercentage(); }
    public byte getSetType()
   {
       return panel.getSetType();
   }
    public StsPointList getPointSetToAppend() { return panel.getPointSetToAppend(); }
