 ...
 * @version 1.0
 */
public class StsPostStackTraceDefinition2d extends StsPostStackTraceDefinition
{
	public StsPostStackTraceDefinition2d(StsWizard wizard)
	{
		super(wizard);
        header.setLink("http://www.s2ssystems.com/Protected/Marketing/AppLinks.html#PostStack2d");                                        
	}

	public StsPostStackTraceDefinitionPanel getPanel()
	{
		return new StsPostStackTraceDefinitionPanel2d(wizard, this);
	}
	...
	{
		return "http://www.s2ssystems.com/Protected/Marketing/AppLinks.html#PostStack2d";
	}
