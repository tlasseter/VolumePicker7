 ...
 * @version 1.0
 */
public class StsSegyVspTraceDefinition extends StsPostStackTraceDefinition

{

	public StsSegyVspTraceDefinition(StsWizard wizard)
	{
		super(wizard);
	...
	{
		return "VSP Trace Header Details";
	}
    ...
    {
        return  new StsSegyVspTraceDefinitionPanel(wizard, this);
    }
}
