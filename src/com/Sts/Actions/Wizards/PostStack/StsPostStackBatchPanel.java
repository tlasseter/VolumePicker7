...
public class StsPostStackBatchPanel extends StsJPanel implements StsTableModelListener {
	// Z Domain
	...
	public StsPostStackBatchPanel(StsWizard wizard, StsWizardStep wizardStep)
	{
