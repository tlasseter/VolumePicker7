...
public class StsPreStackLoadSelect2d extends StsWizardStep
{
    StsPreStackLoadSelect2dPanel panel;
    StsHeaderPanel header;

    public StsPreStackLoadSelect2d(StsWizard wizard)
    {
        super(wizard);
        panel = new StsPreStackLoadSelect2dPanel(wizard, this);
    ...
    {
        wizard.dialog.setTitle("Selecting Available 2D Lines");
        return true;
    }
