...
public class StsPreStackBatchPanel extends StsJPanel implements StsTableModelListener
{
	// Z Domain
	...
	public StsPreStackBatchPanel(StsWizard wizard, StsWizardStep wizardStep)
	{
