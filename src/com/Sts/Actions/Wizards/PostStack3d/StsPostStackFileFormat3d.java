...
public class StsPostStackFileFormat3d extends StsPostStackFileFormat 
{
    public StsPostStackFileFormat3d(StsSeismicWizard wizard)
	{
		super(wizard);
	}
    ...
    {
        header.setTitle("Poststack 3d SegY Definition");
