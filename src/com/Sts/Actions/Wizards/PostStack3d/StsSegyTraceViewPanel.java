...
public class StsSegyTraceViewPanel extends JPanel implements ActionListener, ChangeListener//, ItemListener
{
    ...
    public StsSegyTraceViewPanel(StsWizard wizard, StsWizardStep wizardStep)
    {
...
//            slider.addItemListener(this);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            StsSeismicBoundingBox[] vols = wizard.getSegyVolumes();
