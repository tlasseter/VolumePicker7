...
public class StsFilterVVolumePanel extends StsJPanel
{
    ...
    public StsFilterVVolumePanel(StsWizard wizard, StsWizardStep wizardStep)
    {
        this.wizard = wizard;
    ...
    public void initialize()
    {
        ...
        selectPanel = StsJPanel.addInsets();
    ...
    {
        ((StsFilterVVolume)wizardStep).applyFilter(volume, filter, volumeName);
    }
