...
public class StsFilterVVolume extends StsWizardStep
{
    StsFilterVVolumePanel panel;
    StsHeaderPanel header;
	StsFilterVirtualVolume virtualVolume = null;
    String volumeName = null;
    StsProgressPanel ppanel = null;

    public StsFilterVVolume(StsWizard wizard)
	{
        super(wizard);
        panel = new StsFilterVVolumePanel(wizard, this);
        header = new StsHeaderPanel();
        setPanels(panel, header);
        panel.setPreferredSize(new Dimension(500, 200));
        header.setTitle("Virtual PostStack3d Definition");
        header.setSubtitle("Defining Filtered Virtual PostStack3d");
...
//        name = ((StsVirtualVolumeWizard)wizard).getVolumeName();
        ...
        virtualVolume = new StsFilterVirtualVolume(volume, filter, name);   
