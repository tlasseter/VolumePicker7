...
public class StsWellPlanSelect extends StsWizardStep
{
    StsWellPlanSelectPanel panel;
    StsHeaderPanel header, info;

    public StsWellPlanSelect(StsWizard wizard)
    {
        super(wizard);
        panel = new StsWellPlanSelectPanel(wizard, this);
