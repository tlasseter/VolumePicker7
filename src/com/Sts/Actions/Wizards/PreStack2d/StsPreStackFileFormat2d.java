 ...
 */
public class StsPreStackFileFormat2d extends StsPostStackFileFormat
{
    public StsPreStackFileFormat2d(StsSeismicWizard wizard)
    {
        super(wizard);
    }
    ...
    {
        header.setTitle("Prestack 2d SegY Definition");
		...
		header.setInfoText(wizardDialog,
                ...
                "      **** Dont worry if values in table are incorrect, next screen allows trace header mapping.****");
    }
}
