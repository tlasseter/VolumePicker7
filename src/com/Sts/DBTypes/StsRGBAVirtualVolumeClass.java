...
public class StsRGBAVirtualVolumeClass extends StsVirtualVolumeClass implements StsSerializable, StsClassSurfaceDisplayable, StsClassCursor3dTextureDisplayable //, StsClassDisplayable
{
    public StsRGBAVirtualVolumeClass()
    {
        userName = "RGBA Virtual Volume";
    }
