...
public class StsEPFVirtualVolume extends StsVirtualVolume implements StsTreeObjectI
{
    /**
	 * 
	 */
    ...
    public StsEPFVirtualVolume()
    {
    }

    public StsEPFVirtualVolume(StsSeismicVolume volume, StsVolumeFilterFace filter, String name)
    {
        super(false);
