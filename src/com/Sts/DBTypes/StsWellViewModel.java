...
abstract public class StsWellViewModel extends StsSerialize
{
    ...
    /** well nextWindow is currently being isVisible */
    ...
    /** measured depth at bottom of nextWindow; top is computed on demand based on nextWindow size */
    ...
    /** Action manager for this nextWindow, all panels */
    ...
    /** initial nextWindow X */
    static int windowX = 100;

    /** initial nextWindow Y */
    static int windowY = 100;

    /** nextWindow dX to next nextWindow */
    static int windowDX = 25;

    /** nextWindow dY to next nextWindow */
...
//            rebuild();
    ...
    /** well measured depth min at top of nextWindow. */
