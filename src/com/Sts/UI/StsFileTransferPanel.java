...
public class StsFileTransferPanel extends StsGroupBox
{
    ...
    public StsFileTransferPanel(String currentDirectory, StsFilenameFilterFace filenameFilter, StsFileTransferObjectFaceNew listener,
	...
	public StsFileTransferPanel(String currentDirectory, StsFilenameFilterFace filenameFilter, StsFileTransferObjectFaceNew listener, int width, int height)
	{
