...
public class StsIntFieldBeanBeanInfo extends SimpleBeanInfo {
    private Class beanClass = StsIntFieldBean.class;
    private String iconColor16x16Filename;
    private String iconColor32x32Filename = "StsIntFieldBean.gif";
    private String iconMono16x16Filename;
    private String iconMono32x32Filename;

    public StsIntFieldBeanBeanInfo() {
    }
