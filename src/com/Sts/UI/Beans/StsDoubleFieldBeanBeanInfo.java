...
public class StsDoubleFieldBeanBeanInfo extends SimpleBeanInfo
{
    private Class beanClass = StsDoubleFieldBean.class;
    private String iconColor16x16Filename;
    private String iconColor32x32Filename = "StsDoubleFieldBean.gif";
    private String iconMono16x16Filename;
    private String iconMono32x32Filename;

    public StsDoubleFieldBeanBeanInfo()
    {
    }
